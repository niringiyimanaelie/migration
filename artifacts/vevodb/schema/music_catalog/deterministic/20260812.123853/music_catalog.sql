CREATE SCHEMA IF NOT EXISTS vevodb.music_catalog
...
;
-- ** SSC-EWI-0001 - UNRECOGNIZED TOKEN ON LINE '1' COLUMN '66' OF THE SOURCE CODE STARTING AT ':'. EXPECTED 'STATEMENT' GRAMMAR. **
-- :aws1
      ;