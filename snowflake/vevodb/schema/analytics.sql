CREATE SCHEMA IF NOT EXISTS vevodb.analytics
...
;
-- ** SSC-EWI-0001 - UNRECOGNIZED TOKEN ON LINE '1' COLUMN '62' OF THE SOURCE CODE STARTING AT ':'. EXPECTED 'STATEMENT' GRAMMAR. **
-- :aws1
      ;