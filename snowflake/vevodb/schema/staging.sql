CREATE SCHEMA IF NOT EXISTS vevodb.staging
...
;
-- ** SSC-EWI-0001 - UNRECOGNIZED TOKEN ON LINE '1' COLUMN '60' OF THE SOURCE CODE STARTING AT ':'. EXPECTED 'STATEMENT' GRAMMAR. **
-- :aws1
      ;